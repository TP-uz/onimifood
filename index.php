...
<body>
    ...
    <section class="part_2 container">
        <div class="intro">
            ...
            <p>Hello, we’re Omnifood, your new premium food delivery service. We know you’re always busy.<br> No time
                for cooking. So let us take care of that, we’re really good at it, we promise!</p>
        </div>
        <div class="detail">
            <div class="row">
    ...
    <section class="part_5">
        <div class="container">
            <div class="intro">
                <p class="title">We're currently in these cities</p>
            </div>
            <div class="detail">
                <div class="cart">
                    ...
                    <p class="text"><i class="fas fa-user"></i> 1600+ Happy Eater</p>
                    <p class="text"><i class="fas fa-star"></i> 60+ Top Chefs</p>
                    <div class="contact1">
                        <a href="" class="contact"><i class="fab fa-twitter">
                        </i>@ominifood_lx</a>
                    </div>
                </div>
                <div class="cart">
        ...
        <div class="container">
            ...
            <div class="detail">
                <div class="cart">
                    <p id="Head">Premium</p>
                    <div class="div">
                        <span id="Price">$399</span>
                        <span id="Month">/month</span>
                    </div>
                    <p>That's only 13.30$ per meal</p>
                    <hr>
                    <p class="text"><i class="fas fa-check"></i> 1 meal every day</p>
                    <p class="text"><i class="fas fa-check"></i> Order 24/7</p>
                    <p class="text"><i class="fas fa-check"></i> Access to newest creations</p>
                    <p class="text"><i class="fas fa-check"></i> Free delivery</p>
                    <hr>
                    <div class="button1">
                        <a href="" class="4">
                            Sign up now 
                ...
                <div class="cart">
                    <p id="Head">Pro</p>
                    <div class="div">
                        <span id="Price">$149</span>
                        <span id="Month">/month</span>
                    </div>
                    <p>That's only 14.90$ per meal</p>
                    <hr>
                    <p class="text"><i class="fas fa-check"></i> 1 meal 10 days/month</p>
                    <p class="text"><i class="fas fa-check"></i> Order 24/7</p>
                    <p class="text"><i class="fas fa-check"></i> Access to newest creations</p>
                    <p class="text"><i class="fas fa-check"></i> Free delivery</p>
                    <hr>
                ...
                <div class="cart">
                    ...
                    <p>That's only 14.90$ per meal</p>
                    <hr>
                    <p class="text"><i class="fas fa-check"></i> 1 meal</p>
                    <p class="text"><i class="fas fa-check"></i> Order from 8 am to 12 pm</p>
                    <p class="text"><i class="fas fa-times"></i> </p>
                    <p class="text"><i class="fas fa-check"></i> Free delivery</p>
                    <hr>
                    <div class="button3">
                        <a href="" class="6">
